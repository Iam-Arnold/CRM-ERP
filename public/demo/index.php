...
print '<a alt="Official portal of your ERP CRM application" targe="_blank" href="https://www.dolibarr.org?utm_medium=website&utm_source=demo"><img class="demologo" src="'.DOL_URL_ROOT.'/theme/sphericalLogo.jpg" alt="Dolibarr logo"></a>';
print '</div>';
print '</div>';
