...
function llxHeaderSurvey($title, $head = "", $disablejs = 0, $disablehead = 0, $arrayofjs = [], $arrayofcss = [], $numsondage = '')
{
	...
	if ($urllogo) {
		...
		if (!getDolGlobalString('MAIN_HIDE_POWERED_BY')) {
			print '<div class="poweredbypublicpayment opacitymedium right"><a class="poweredbyhref" href="https://wa.me/message/ELIAM3PMLRMQE1" target="dolibarr" rel="noopener">'.$langs->trans("Contact Developer").'<br><img src="'.DOL_URL_ROOT.'/theme/sphericalLogo.jpg" width="80px"></a></div>';
		}
		print '</div>';
	}
