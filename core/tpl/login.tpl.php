...
<!-- Title with version -->
<div class="login_table_title center" title="<?php echo dol_escape_htmltag("Login - CRM"); ?>">
<?php
if ($disablenofollow) {
	echo '<a class="login_table_title" href="https://wa.me/message/ELIAM3PMLRMQE1" target="_blank" rel="noopener noreferrer external">';
}
echo dol_escape_htmltag("Contact Developer");
if ($disablenofollow) {
	echo '</a>';
}
?>
